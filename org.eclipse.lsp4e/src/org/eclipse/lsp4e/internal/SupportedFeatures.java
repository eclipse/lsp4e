...
public class SupportedFeatures {
	...
	public static @NonNull WorkspaceClientCapabilities getWorkspaceClientCapabilities() {
		...
		DidChangeConfigurationCapabilities didChangeConfigurationCapabilities = new DidChangeConfigurationCapabilities(Boolean.TRUE);
		workspaceClientCapabilities.setDidChangeConfiguration(didChangeConfigurationCapabilities);
