...
public class CallHierarchyContentProvider implements ITreeContentProvider {
    ...
    public Object[] getChildren(final Object parentElement) {
        if (parentElement instanceof CallHierarchyViewTreeNode) {
            return findCallers((CallHierarchyViewTreeNode) parentElement);
        } else {
            return new Object[0];
        }
    }
    ...
    public Object getParent(final Object element) {
        if (element instanceof CallHierarchyViewTreeNode) {
            return ((CallHierarchyViewTreeNode) element).getParent();
        }
        return null;
    }
    ...
    public void inputChanged(final Viewer viewer, final Object oldInput, final Object newInput) {
        ...
        if (newInput instanceof CallHierarchyViewInput) {
            rootMessage = FINDING_CALLERS;
            rootItems = null;
            CallHierarchyViewInput viewInput = (CallHierarchyViewInput) newInput;
