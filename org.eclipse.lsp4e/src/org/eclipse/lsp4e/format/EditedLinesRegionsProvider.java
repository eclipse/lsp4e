...
public class EditedLinesRegionsProvider implements IFormatRegionsProvider {
	...
	public IRegion[] getFormattingRegions(IDocument document) {
		return calculateEditedLineRegions(document, new NullProgressMonitor());
	}
	 ...
	 *
	 */
	private IRegion[] calculateEditedLineRegions(final IDocument document, final IProgressMonitor monitor) {
